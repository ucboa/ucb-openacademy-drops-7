 ...
 */
function openacademy_default_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  $form['#submit'][] = 'openacademy_default_theme_settings_submit';
  $form['#validate'][] = 'openacademy_default_theme_settings_validate';
}

/**
 * Custom Validation Hook
 */
function openacademy_default_theme_settings_validate($form, &$form_state) {
  // Handle file uploads.
 ...
 * Custom Submit Hook
 */
function openacademy_default_theme_settings_submit($form, &$form_state) {
